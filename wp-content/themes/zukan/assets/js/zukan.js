...
$(function(){
    ...
    function createTrain(trains){
        ...
        trains.forEach(function(train, index){
            html_train_data += `<div class="p-trainList__item" >
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/zukan/${train['company_en']}/${train['series_en']}.jpg" alt="" class="p-trainList__img">
                <div class="p-trainList__wrap">
                    ...
                    <div class="c-btn">
                        <a href="<?php echo get_template_directory_uri(); ?>/zukan_trainDetail.html?series_en=${train['series_en']}">${train['company_ja']}${train['series']}を見る！</a>
                    </div>
                </div>
            </div>`;
        });
    ...
    if( page_type == 'company'){
        ...
        // バナー画像取得 
        $('#bannerImg').attr('src', `<?php echo get_template_directory_uri(); ?>/assets/img/banner/${param_value}_banner.png`);
    ...
    if( page_type == 'Detail'){
        ...
        // 画像取得
        $('.p-trainImg__image').attr('src', `<?php echo get_template_directory_uri(); ?>/assets/img/zukan/${train_detail['company_en']}/${train_detail['series_en']}.jpg`);
        
        // リンクルート会社名表示
        $('#company_name').attr('href', `<?php echo get_template_directory_uri(); ?>/zukan_company.html?company_en=${train_detail['company_en']}`);
